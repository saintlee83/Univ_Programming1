...
class PopulationAnalysisApp(QWidget):
    ...
    def init_ui(self):
        ...
        # 설명 라벨
        desc_label = QLabel('행정동 이름을 입력한 후 분석 버튼을 클릭하세요.')
    ...
    def start_analysis(self):
        ...
        # 파일 경로 직접 지정 (절대 경로)
        file_path1 = '/Users/saintlee83/Documents/code/git_clones/Univ_Programming1/Lectures/midterm/data/LOCAL_PEOPLE_DONG_201912.csv'
        file_path2 = '/Users/saintlee83/Documents/code/git_clones/Univ_Programming1/Lectures/midterm/data/dong_code.csv'
